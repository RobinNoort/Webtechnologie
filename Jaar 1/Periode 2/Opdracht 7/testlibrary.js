// Voor de unittests
function test(inp, outp, fn){
    const resultcode = fn(...inp);
  
    console.log(`Input '${inp}'`);
    console.log(`Expected '${beautify(outp)}'`, `Got '${beautify(resultcode)}'`);
  
    if (isEqual(resultcode,outp)) {
  ...
  function testtype(inp, outp, fn){
    const resultcode = typeof fn(...inp);
  
    console.log(`Input '${inp}'`);
    console.log(`Expected '${outp}'`, `Got '${resultcode}'`);
